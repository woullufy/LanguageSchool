...
def show_tables():
    ...
    for table_name in tables: 
        ...
        data[table_name] = {"columns": columns, "rows": rows_as_dicts}

    cursor.close()
    conn.close()

    return render_template("data_views/tables.html", data=data, db_type='sql')
...
def show_tables_courses():
    ...
    return render_template("data_views/courses_mongo.html", courses=courses)
...
def show_tables_students():
    ...
    return render_template("data_views/students_mongo.html", students=students)
...
def show_tables_employees():
    ...
    return render_template("data_views/employees_mongo.html", employees=employees)


@main_bp.route("/admin-dashboard")
def dashboard_admin():
    db_mode = session.get("active_db_mode", "sql")
    return render_template("dashboards/admin.html", db_mode=db_mode)
